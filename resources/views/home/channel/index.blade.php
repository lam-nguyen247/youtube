                                ...
                                <div class="col-lg-6 col-md-12" style="order: 1 !important">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <span> Từ </span> <input style="width: 85%; margin-bottom: 10px; margin-left: 5px;" placeholder="từ" value="{{isset($_GET['price_f'])?$_GET['price_f']:0}}"  type="number" id="price_f" name="price_f">
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <span> Đến </span> <input style="width: 85%; margin-bottom: 10px; margin-left: 5px;" placeholder="đến"  value="{{isset($_GET['price_t'])?$_GET['price_t']:0}}"  type="number" id="price_t" name="price_t">
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-12" style="order: 2 !important">
                                   <div class="row">
                                        ...
                                        <div class="col-md-5 col-sm-12">
                                            <span> Từ </span> <input style="width: 85%; margin-bottom: 10px; margin-left: 5px;"  value="{{isset($_GET['sub_f'])?$_GET['sub_f']:0}}"  type="number" id="sub_f" name="sub_f">
                                        </div>
                                        <div class="col-md-5 col-sm-12">
                                            <span> Đến </span> <input style="width: 85%; margin-bottom: 10px; margin-left: 5px;" value="{{isset($_GET['sub_t'])?$_GET['sub_t']:0}}"  type="number" id="sub_t" name="sub_t">
                                        </div>
                                    </div>
                                </div>
