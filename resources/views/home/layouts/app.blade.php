...
<head>
    ...
    @else
        ...
        @cms
        <!-- Favicon icon -->
        <link rel="icon" type="image/png" sizes="64x64" href="{{ url('/images/home/logo-white-icon.png') }}">
        ...
        <script>
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-PZ6T4PS');
        </script>
    ...
    <body id="body-site">
        ...
        <noscript>
            <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PZ6T4PS" height="0" width="0"
        ...
        <div class="navigation">
            ...
            <h3 id="navigation__title" class="navigation__title" data-cms="{{ app()->getLocale() }}-layouts-app-23">Let's
                talk</h3>
                ...
                <label class="theme-switch" for="checkbox">
                    ...
                    <div class="slider round">
                        <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            xml:space="preserve" width="0.502638in" height="0.501575in" version="1.1"
                            viewbox="0 0 502.64 501.57">
                            <g id="Layer_x0020_1">
                                <metadata id="CorelCorpID_0Corel-Layer"></metadata>
                                <path class="fil0"
                                    d="M500.62 322.06c-38.53,9.01 -72.33,40.44 -155.22,25.45 -51.69,-9.35 -97.71,-37.16 -124.62,-64.83 -63.29,-65.09 -86.84,-158.41 -52.58,-248.15 3.59,-9.4 11.11,-21.61 13.05,-31.98 -85.44,28.76 -144,83.86 -171.61,170.21 -33.74,105.52 11.37,203.76 63.6,257.39 128.48,131.92 374.62,82.21 427.37,-108.09z">
                                </path>
                            </g>
                        </svg>
                    </div>
                            ...
                            <div class="navigation__flex">
                                <div class="navigation__content">
                                    ...
                                    <ul class="navigation__list" id="navi-menu">
                                        ...
                                        <li class="navigation__item">
                                            <a href="/chuyen-nhuong-lai-kenh-youtube"
                                                class="navigation__link">@lang('Buy-Channels')</a>
                                        </li>
                                        <li class="navigation__item">
                                    ...
                                    <div class="navigation__info">
                                        <ul class="navigation-list">
                                            <li><i class="fa fa-phone" aria-hidden="true"></i> <a
                                                    ...
                                                    data-cms="{{ app()->getLocale() }}-layouts-app-70">0899.707.888</a>
                                            </li>
                                            <li><span data-cms="{{ app()->getLocale() }}-layouts-app-73">Email:</span> <a
                                                    href="mailto:{{ $config->email }}" title="Email"
                                                    data-cms="{{ app()->getLocale() }}-layouts-app-74">mrkiengmcc@gmail.com</a>
                                            </li>
                                            <li><i class="fa fa-map-marker" aria-hidden="true"></i> <span
                                                    data-cms="{{ app()->getLocale() }}-layouts-app-77">Zalo:
                                                    0899707888</span></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="header__logo-box d-flex align-items-center">
                            <a href="/" title="logo">
                                <img class="img-fluid" @src="/images/home/logo-white.png"
                                    alt="{{ config('app.name') }}">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 col-lg-4">
                            <div class="footer-content">
                                <h1 style="font-size: 2rem" class="title"
                                    data-cms="{{ app()->getLocale() }}-layouts-app-93">Thông tin công ty</h1>
                                <ul class="footer-list">
                                    <li><span data-cms="{{ app()->getLocale() }}-layouts-app-100">Địa chỉ 1: Số 28A Ngõ
                                            162 Khương Đình - Thanh Xuân - Hà Nội </span></li>
                                    <li><span data-cms="{{ app()->getLocale() }}-layouts-app-100-2">Địa chỉ 2: 62A Đà Sơn,
                                            Hoà Khánh Nam, Liên Chiểu, Tp. Đà Nẵng</span></li>
                                    <li><span data-cms="{{ app()->getLocale() }}-layouts-app-100-3">CÔNG TY CỔ PHẦN CÔNG
                                            NGHỆ TRUYỀN THÔNG MK MEDIA</span></li>
                                    <li><span data-cms="{{ app()->getLocale() }}-layouts-app-106-2">Mã số thuế:
                                            0109379379</span> </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-12 col-md-5 col-lg-3">
                            <div class="footer-content">
                                ...
                                <ul class="footer-list">
                                    <li><a href="tel:{{ $config->phone }}"
                                            title="Số điện thoại">{{ $config->phone }}</a></li>
                                    ...
                                    <li>
                                        <a href='http://online.gov.vn/Home/WebDetails/89727'> <img style="width:70%"
                                                src='/public/images/logoSaleNoti.png' /></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="footer-content">
                        ...
                        <div class="col-12 col-md-4 col-lg-2">
                            <div class="footer-content">
                                ...
                                <ul class="footer-list">
                                    <li><a href="/@lang('channels')" title="@lang('Channels')">@lang('Channels')</a>
                                    </li>
                                    <li><a href="/@lang('buy-channels')" title="@lang('Buy-Channels')">@lang('Buy-Channels')</a>
                                    </li>
                                    <li><a href="/chinh-sach-bao-mat" title="Chính sách bảo mật">Chính sách bảo mật</a>
                                    </li>
                                    <li><a href="/chinh-sach-giao-nhan-cai-dat"
                                            title="Chính sách giao nhận & cài đặt">Chính sách giao nhận & cài đặt</a></li>
                                    <li><a href="/chinh-sach-hoan-tien" title="Chính sách hoàn tiền">Chính sách hoàn
                                            tiền</a></li>
                        ...
                        <div class="col-8 col-md-3 col-lg-3">
                            <div class="footer-content">
                                ...
                                <div class="fb-page" data-href="https://www.facebook.com/Youtubestore.vn"
                                    data-tabs="timeline" data-width="" data-height="200" data-small-header="true"
                                    data-adapt-container-width="true" data-hide-cover="true" data-show-facepile="true">
                                    <blockquote cite="https://www.facebook.com/Youtubestore.vn"
        ...
        <script async defer crossorigin="anonymous"
            src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v10.0&appId=585723972044551&autoLogAppEvents=1"
            nonce="2spNzV4z"></script>
        <script>
